...
- (void)setTextBannerCellWithCell:(UICollectionViewCell *)cell withIndexPath:(NSIndexPath *)indexPath {
    if (self.bannerType == BannerType_TextBanner) {
        ...
        [self changeSpaceForLabel:label withLineSpace:8.0 WordSpace:2];
//        NSMutableAttributedString *mutableAttributedString = nil;
//        mutableAttributedString = [[NSMutableAttributedString alloc] initWithString:label.text];
//        NSRange normalRange = [[mutableAttributedString string] rangeOfString:@"渔家乐名称:" options:NSCaseInsensitiveSearch];
//        [mutableAttributedString addAttribute:NSForegroundColorAttributeName value:[UIColor redColor] range:normalRange];
...
- (void)changeSpaceForLabel:(UILabel *)label withLineSpace:(float)lineSpace WordSpace:(float)wordSpace {
    ...
    NSRange normalRange = [[attributedString string] rangeOfString:@"渔家乐名称:" options:NSCaseInsensitiveSearch];
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:normalRange];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:normalRange];
    NSRange normalRange1 = [[attributedString string] rangeOfString:@"检查部门:" options:NSCaseInsensitiveSearch];
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:normalRange1];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:normalRange1];
    NSRange normalRange2 = [[attributedString string] rangeOfString:@"检查时间:" options:NSCaseInsensitiveSearch];
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:normalRange2];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:normalRange2];
